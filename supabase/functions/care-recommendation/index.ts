...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const wellbeingPrompt = `Identified needs:\n${needsText}\n\nSynoptic snapshot:\n${synopticText}${consentLine}${adjustmentsLine}\n\nProduce a PERSONAL WELLBEING PLAN written in the first person ("I"), creative but grounded in the synoptic content. Keep it concise and scannable for a mental health nurse — aim for ~280 words total. Use these EXACT numbered markdown headings in this order, each followed by 1-3 short bullet points or 1-2 sentences:\n\n### 1. What Matters To You?\n### 2. What Has Happened? What Is The Situation?\n### 3. Long Term Goals\n### 4. Mental Health Goals & Agreed Actions\n### 5. Personal Safety Goals\n### 6. Physical Health Goals\n### 7. Early Warning Signs\n### 8. What Support Works For You\n### 9. Main Support / Next of Kin (NOK)\n### 10. Reasonable Adjustments\n### 11. Safety Plan (Risk-Based)\n\nFor section 10, reflect any adjustments noted above (or write "None requested"). For section 11, draft a short safety plan ONLY if risks (self-harm, suicidal ideation, crisis, abuse, substance misuse, medication non-compliance) are present in the synoptic — include: triggers, warning signs, internal coping strategies, people/places that help, professionals/crisis contacts (Samaritans 116 123, Shout 85258, NHS 111 option 2, 999), and how to make the environment safer. If no risks are present, write "No active risks identified — review at next contact." If consent is NO, add a one-line note at the top: "⚠️ Consent NOT given to share — discuss with service user before forwarding." Do not invent clinical diagnoses. Keep tone warm and recovery-focused.`;
